...
const ProductFilter = () => {
  ...
  return (
    <>
      <ProductCategoryFilter>
        <FilterTitle className="filter-title flex items-center justify-between">
          <p className="filter-title-text text-gray text-base font-semibold text-lg">
            Filter
          </p>
          <span className="text-gray text-xxl">
      ...
      <SizesFilter>
        ...
        <FilterWrap
          className={`${!isSizeFilterOpen ? "hide" : ""}`}
        >
      ...
      >
        ...
        <FilterWrap
          className={`${!isStyleFilterOpen ? "hide" : ""}`}
        >
