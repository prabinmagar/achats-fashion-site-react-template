          ...
          <div className="tabs-contents">
            ...
            >
              <ContentStylings>
                ...
                <p>
                  *Important: Please Make sure that the mobile number filled in
                  the address when the checkout is easy to reach (Tlp. & Sms) /
                  (Include 2 Mobile Phone Numbers if necessary)
                </p>
                ...
                <p>
                  The picture is only as a reference to the image resemblance to
                  the original only 85-90% (differences may be caused due to the
                  use of materials,color ,size,model,and other,please be advised
                  that there is an inappropriate)
                </p>
              </ContentStylings>
            </div>
